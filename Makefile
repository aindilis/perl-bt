# This Makefile is for the perl-btpm extension to perl.
#
...
TO_INST_PM = lib/FRDCSA/BehaviorTreePlanMonitor.pm \
	lib/FRDCSA/BehaviorTreePlanMonitor/Blackboard.pm \
	lib/FRDCSA/BehaviorTreePlanMonitor/Blackboard/Key.pm \
	lib/FRDCSA/BehaviorTreePlanMonitor/Blackboard/KeyUpdate.pm \
	lib/FRDCSA/BehaviorTreePlanMonitor/Blackboard/StateUpdate.pm \
	lib/FRDCSA/BehaviorTreePlanMonitor/Blackboard/Watcher.pm \
	lib/FRDCSA/BehaviorTreePlanMonitor/Node/Base.pm \
	lib/FRDCSA/BehaviorTreePlanMonitor/Node/Composite.pm \
	lib/FRDCSA/BehaviorTreePlanMonitor/Node/Root.pm \
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: perl-btpm' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "perl-btpm",' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="perl-btpm" VERSION="0.01">' > perl-btpm.ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT></ABSTRACT>' >> perl-btpm.ppd
	$(NOECHO) $(ECHO) '    <AUTHOR></AUTHOR>' >> perl-btpm.ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> perl-btpm.ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Mojolicious::" VERSION="8.40" />' >> perl-btpm.ppd
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="x86_64-linux-gnu-thread-multi-5.28" />' >> perl-btpm.ppd
	$(NOECHO) $(ECHO) '        <CODEBASE HREF="" />' >> perl-btpm.ppd
	$(NOECHO) $(ECHO) '    </IMPLEMENTATION>' >> perl-btpm.ppd
	$(NOECHO) $(ECHO) '</SOFTPKG>' >> perl-btpm.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  'lib/FRDCSA/BehaviorTreePlanMonitor.pm' 'blib/lib/FRDCSA/BehaviorTreePlanMonitor.pm' \
	  'lib/FRDCSA/BehaviorTreePlanMonitor/Blackboard.pm' 'blib/lib/FRDCSA/BehaviorTreePlanMonitor/Blackboard.pm' \
	  'lib/FRDCSA/BehaviorTreePlanMonitor/Blackboard/Key.pm' 'blib/lib/FRDCSA/BehaviorTreePlanMonitor/Blackboard/Key.pm' \
	  'lib/FRDCSA/BehaviorTreePlanMonitor/Blackboard/KeyUpdate.pm' 'blib/lib/FRDCSA/BehaviorTreePlanMonitor/Blackboard/KeyUpdate.pm' \
	  'lib/FRDCSA/BehaviorTreePlanMonitor/Blackboard/StateUpdate.pm' 'blib/lib/FRDCSA/BehaviorTreePlanMonitor/Blackboard/StateUpdate.pm' \
	  'lib/FRDCSA/BehaviorTreePlanMonitor/Blackboard/Watcher.pm' 'blib/lib/FRDCSA/BehaviorTreePlanMonitor/Blackboard/Watcher.pm' \
	  'lib/FRDCSA/BehaviorTreePlanMonitor/Node/Base.pm' 'blib/lib/FRDCSA/BehaviorTreePlanMonitor/Node/Base.pm' \
	  'lib/FRDCSA/BehaviorTreePlanMonitor/Node/Composite.pm' 'blib/lib/FRDCSA/BehaviorTreePlanMonitor/Node/Composite.pm' \
	  'lib/FRDCSA/BehaviorTreePlanMonitor/Node/Root.pm' 'blib/lib/FRDCSA/BehaviorTreePlanMonitor/Node/Root.pm' \
